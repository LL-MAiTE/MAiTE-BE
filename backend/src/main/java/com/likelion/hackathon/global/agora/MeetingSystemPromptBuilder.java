...
public class MeetingSystemPromptBuilder {
    ...
    public String build(Agenda agenda, List<Position> positions, List<AgendaReferenceDocument> refDocs) {
        ...
        sb.append("=== 행동 지침 ===\n");
        sb.append("- 상대방의 발언을 잘 듣고 안건에 맞는 답변을 제공하세요.\n");
        sb.append("- 안건에 없는 내용이면 '해당 사항은 내부 확인 후 답변드리겠습니다'라고 하세요.\n");
        sb.append("- 숫자나 조건을 제시할 때는 명확하게 말하세요.\n");
        sb.append("- 협상 범위를 벗어나는 요구에는 정중히 거절하세요.\n");
